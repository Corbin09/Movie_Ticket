...
public class MoviesController {
    ...
    public String addMovie(@ModelAttribute FilmDTO filmDTO) {
        ...
        return "redirect:/manage-movies/add-movie?success";
    }

    @GetMapping("/manage-movies/edit-movie/{id}")
    public String showEditMovieForm(@PathVariable Long id, Model model, RedirectAttributes redirectAttributes, HttpServletRequest request) {
        try {
    ...
    public String updateMovie(@PathVariable Long id, @ModelAttribute FilmDTO filmDTO) {
        filmService.updateFilm(id, filmDTO); // đã có sẵn
        return "redirect:/manage-movies";
    }
